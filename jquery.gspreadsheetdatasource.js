		...
		$(xml).find('item').each(function(){
		    ...
		    for (var fieldkey in fields)
			  ...
			  fieldName = fields[fieldkey];
		    	  var index = description.indexOf(fieldName+":");
			  if (index==-1)
			  {
				alert("The field "+fieldName+" could not be found");
				return null;
			  }
			...
			if (index_1==null)
			{
				index_1=indexes[fieldName]+fieldName.length+1;
			...
			else
			{
				...
				var value= description.substring(index_1, index_2);
